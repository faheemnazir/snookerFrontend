      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
        ...
        <div className="flex items-center gap-3">
          <NavLink to="/" className="flex items-center gap-3">
            ...
            <span className="hidden sm:block font-heading text-2xl font-bold tracking-tight uppercase text-transparent bg-clip-text bg-gradient-to-r from-accent via-green-500 to-white drop-shadow-[0_2px_2px_rgba(0,0,0,1)]">
  The Snooker Academy
</span>
          </NavLink>
        </div>
